...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-salary-record.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEESALARYRECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMPLOYEESALARYRECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMPLOYEESALARYRECORD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EMPLOYEESALARYRECORD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEESALARYRECORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMPLOYEESALARYRECORD actions', async () => {
      const arg = 42666;
